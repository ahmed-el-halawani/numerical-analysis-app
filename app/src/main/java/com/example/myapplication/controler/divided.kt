...
import com.example.myapplication.ui.LagrangeDividedMethod
...
class divided(context: Context, ActivityView: LagrangeDividedMethod, val table:TableMaker) {
    init {
        val x = ActivityView.xValue_unequal.text.toString().trim().toDouble()
        ...
        ActivityView.methodSolve_unequal.addView(view)

        ActivityView.lengthOfMethod_unequal.tv_methodLength.text =
